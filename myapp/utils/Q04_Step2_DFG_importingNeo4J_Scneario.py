...
if step_createReifiedEntities:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH (n) where n.Category="Relative"  RETURN n limit 25;
        '''
...
if step_entities_with_diff_ID_relationships:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH p=(n1) -[rel:REL]-> ( n2 ) where n1.Category="Absolute" and n2.Category="Absolute" return p limit 25
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_RelatingReifiedEntitiesAndEntities:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH p=  (n1) <-[:REL {{Type:"Reified"}}]- (en) -[:REL {{Type:"Reified"}}]-> (n2)  where n1.Category="Absolute" and n2.Category="Absolute"   return p limit 25
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_correlate_ReifiedEntities_to_Event:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH p= (e)-[:CORR]->(en)  where en.Category="Relative" return p limit 25
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_createDF:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH p= (first)-[df:DF]-> (second)  return p limit 25
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_deletePolluted_CoRR_Reified_Events:
    ...
    if selenium==True:
        svgFunction.moveDefaultSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
        with open(savingTxt4, 'w') as file:
            file.write(f'''{outDir}/{fileName}.svg''')
        print("\n SVG File was created")
...
if step_aggregateDF_Absolute:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( c1 ) -[:DF_C ]-> ( c2 )  return rel limit 25;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_aggregateDF_Relative:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( c1 ) -[dfc:DF_C ]-> ( c2 )  where dfc.Type="Relative"  return rel limit 25;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_aggregateDF_All:
    ...
    if selenium == True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( c1 ) -[dfc:DF_C ]-> ( c2 )  where dfc.Type="All"  return rel limit 25;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_relEntity:
    ...
    if selenium == True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( a1 ) -[:DF_E {{Type:"One" }} ]-> ( a2 )   return rel limit 25;  
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_relEntityLower:
    ...
    if selenium == True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( a1 ) -[:DF_E {{Type:"Two" }} ]-> ( a2 )   return rel limit 25;  
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_DF_Propery:
    ...
    if selenium == True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( f:Feature ) -[:DF ]-> ( e2:Event )    return rel limit 25;  
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_aggregateDF_Absolute_property:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( c1 ) -[:DF_C {{Type:"AbsoluteProperty" }} ]-> ( c2 )  return rel limit 25;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_aggregateDF_Relative_property:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( c1 ) -[:DF_C {{Type:"RelativeProperty" }} ]-> ( c2 )  return rel limit 25;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_aggregateDF_All_property:
    ...
    if selenium == True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH rel=( c1 ) -[:DF_C {{Type:"AllProperty" }} ]-> ( c2 )  return rel limit 25;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
