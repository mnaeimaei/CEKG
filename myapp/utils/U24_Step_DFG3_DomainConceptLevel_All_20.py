...
import U22_funcCfgs_DFG3_DomainConceptLevel_All_20 as funcConf
import U23_funcs_DFG3_DomainConceptLevel_All_20 as cl9
...
print("EntityOrgValue=", EntityOrgValue)
cl9.DFC_based_on_Origins(EntityOrgValue, DomainColors, EntitiesColors, ListEnDFSHow, Type3_Count, c_white, c_black, dot,
                         driver, domainColTitle, Activity, colTitle, Type3_Domain_selection, Type3_Domain_ID,graphviz_QueryLocation)

print("*********************************Adding_Entities**********************************************")
print("EntityOrgValue=", EntityOrgValue)
cl9.DFC_Adding_Entities(EntityOrgValue, EntitiesColors, ListEnDFSHow, Type3_Count, driver, c_white, c_black, dot,
                        domainColTitle, Type3_Domain_selection, Type3_Domain_ID,graphviz_QueryLocation)

print("*********************************Adding_Domains_Colors_Hint***********************************************************")
print("model_entities_Temp=", EntityOrgValue)
cl9.Adding_Domains_Colors_Hint(EntityOrgValue, ListEnDFSHow, Type3_Count, DomainColors, c_white, c_black, dot, driver,
                               domainColTitle, Type3_Domain_selection, Type3_Domain_ID,graphviz_QueryLocation)
