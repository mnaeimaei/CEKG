...
def DFC_based_on_Origins (final_DFG_List, ID_Colors, ListEnDFSHow, count, case_selector, case_selector_activation, c_white, c_black, dot, driver, DomainColors,domainColTitle,activityScenario, colTitle, case_selector2, Type4_Domain_selection, Type4_Domain_ID, graphviz_QueryLocation):
