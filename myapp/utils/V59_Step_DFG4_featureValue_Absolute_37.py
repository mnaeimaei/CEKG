...
import V57_funcCfgs_DFG4_featureValue_Absolute_37 as funcConf
import V58_funcs_DFG4_featureValue_Absolute_37 as cl9
...
if txtFileExistance == True:
    ...
    if Type4_approach == 1:
        case_selector, case_selector2, case_selector_list = funcConf.case_Selector(Type4_selection_ID_instances)
        print("case_selector=", case_selector)
        print("case_selector2=", case_selector2)
        print("case_selector_list=", case_selector_list)
...
print("final_DFG_List_Abs_color=",final_DFG_List_Abs_color)
cl9.DFC_based_on_Origins(final_DFG_List_Abs_color, ID_Colors, ListEnDFSHow, Type4_Count, case_selector, case_selector_activation, c_white, c_black, dot, driver,Activity, colTitle, case_selector2,graphviz_QueryLocation)


print("*********************************Adding_Entities**********************************************")
print("final_DFG_List_Abs_color=",final_DFG_List_Abs_color)
cl9.DFC_Adding_Entities(final_DFG_List_Abs_color, ID_Colors, ListEnDFSHow, Type4_Count, case_selector, case_selector_activation, case_selector_list, c_white, c_black, dot, driver,graphviz_QueryLocation)
