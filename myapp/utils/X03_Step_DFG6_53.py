...
import X01_funcCfgs_DFG6_53 as funcConf
import X02_funcs_DFG6_53 as cl9
...
if txtFileExistance == True:
    ...
    Entity_Show = txtF.stringTxt(generalFileName, "Entity_Show")
    ...
    Entity_Show = funcConf.nodeOtherRandomFinder(driver)
    print("Entity_Show=", Entity_Show)
...
cl9.DFC_based_on_Origins(case_selector, mainEntity_selection, c_white, c_black, dot, driver,node1,Entity_Show,dfgType,graphviz_QueryLocation)

print("*********************************Adding Entity ***********************************************************")

cl9.Adding_Entities_ID_ForFirstEvent(ID_Colors, case_selector, mainEntity_selection, c_white, c_black, dot, driver,EntitiesColors,node1,Entity_Show,dfgType,graphviz_QueryLocation)



print("*********************************Adding Entity Hint ***********************************************************")

cl9.Adding_Entities(ID_Colors, case_selector, mainEntity_selection, c_white, c_black, dot, driver,EntitiesColors,node1,Entity_Show,graphviz_QueryLocation)


print("*********************************Adding Other Entity Hint ***********************************************************")

cl9.Adding_otherEntities(ID_Colors, case_selector, mainEntity_selection, c_white, c_black, dot, driver,EntitiesColors,node1,Entity_Show,graphviz_QueryLocation)
