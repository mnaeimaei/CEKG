...
if step_treated:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH p=(t:treatedMorbids)-[:INCLUDED]->(d:Disorder)             return p;
        '''
...
if step_NotTreated:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH p=(t:untreatedMorbids)-[:INCLUDED]->(d:Disorder)             return p;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_New:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH p=(t:newMorbids)-[:INCLUDED]->(d:Disorder)             return p;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_multiMorbidityValue:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH (m:Multimorbidity)    CALL apoc.create.vNode(['Multimorbidity'], {{Value: m.Value}}) YIELD node   RETURN node;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_treatedValue:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH (m:treatedMorbids)    CALL apoc.create.vNode(['treatedMorbids'], {{Value: m.Value}}) YIELD node   RETURN node;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_notTreatedValue:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH (m:untreatedMorbids)    CALL apoc.create.vNode(['untreatedMorbids'], {{Value: m.Value}}) YIELD node   RETURN node;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
...
if step_newValue:
    ...
    if selenium==True:
        print("\n Neo4J Query to SVG:")
        runingQuery = f'''
        MATCH (m:newMorbids)    CALL apoc.create.vNode(['newMorbids'], {{Value: m.Value}}) YIELD node   RETURN node;
        '''
        svgFunction.exportNeo4jSVG(runingQuery, driverUserName, driverPassword)
        svgFunction.moveSVG(outDir, fileName)
        savingTxt4 = svgLog + "/" + fileName + "_svg_location.txt"
