...
import V78_funcCfgs_DFG4_featureValue_DomainConceptLevel_Absolute_40 as funcConf
import V79_funcs_DFG4_featureValue_DomainConceptLevel_Absolute_40 as cl9
...
print("final_DFG_List_Abs_color=",final_DFG_List_Abs_color)
cl9.DFC_based_on_Origins(final_DFG_List_Abs_color, ID_Colors, ListEnDFSHow, Type4_Count, case_selector, case_selector_activation, c_white, c_black, dot, driver, DomainColors,domainColTitle,Activity, colTitle,case_selector2, Type4_Domain_selection, Type4_Domain_ID,graphviz_QueryLocation)
