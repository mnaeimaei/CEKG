...
import W29_funcCfgs_DFG5_feature_Relative_45 as funcConf
import W30_funcs_DFG5_feature_Relative_45 as cl9
...
print("rel_list=",rel_list)
cl9.DFC_based_on_Origins(rel_list, ID_Colors, Type5_Count, c_white, c_black, dot, driver,Activity, colTitle ,case_selector_activation1,case_selector_list1,case_selector1,case_selector_activation2,case_selector_list2,case_selector2,graphviz_QueryLocation )



print("*********************************Adding_Entities**********************************************")

cl9.DFC_Adding_Entities(rel_list, Type5_Count, ID_Colors, c_white, c_black,dot, driver,case_selector_activation1,case_selector_list1,case_selector1,case_selector_activation2,case_selector_list2,case_selector2 ,graphviz_QueryLocation)
