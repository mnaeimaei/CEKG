...
import U78_funcCfgs_DFG3_featureValue_DomainConceptLevel_All_28 as funcConf
import U79_funcs_DFG3_featureValue_DomainConceptLevel_All_28 as cl9
...
if txtFileExistance == True:
    ...
    ListEnDFSHow = txtF.ShowTxt(generalFileName, EnNum, "Type3_Entity", "_DF_Show")
    print("Entity_DF_Show (ListEnDFSHow)=", ListEnDFSHow)

    Type3_Count = txtF.TypeCount(generalFileName, "Type3_Count")
    print("Type3_Count=", Type3_Count)

    Type3_Domain_selection = txtF.TrueFalseTxt(generalFileName, "Type3_Domain_selection")
    print("Type3_Domain_selection=", Type3_Domain_selection)

    Type3_Domain_ID = txtF.listIntTxt(generalFileName, "Type3_Domain_ID")
    print("Type3_Domain_ID=", Type3_Domain_ID)
    ...
    Type3_Domain_selection = False
    print("Type3_Domain_selection=", Type3_Domain_selection)

    Type3_Domain_ID = "Not Exist"
    print("Type3_Domain_ID=", Type3_Domain_ID)
...
print("EntityOrgValue=",EntityOrgValue)
cl9.DFC_based_on_Origins(EntityOrgValue, DomainColors, EntitiesColors, ListEnDFSHow, Type3_Count, c_white, c_black, dot, driver,domainColTitle,Activity, colTitle,Type3_Domain_selection , Type3_Domain_ID,graphviz_QueryLocation)


print("*********************************Adding_Entities**********************************************")
print("EntityOrgValue=",EntityOrgValue)
cl9.DFC_Adding_Entities(EntityOrgValue, EntitiesColors, ListEnDFSHow, Type3_Count, driver, c_white, c_black, dot,domainColTitle,Type3_Domain_selection , Type3_Domain_ID,graphviz_QueryLocation)



print("*********************************Adding_Domains_Colors_Hint***********************************************************")
print("model_entities_Temp=",EntityOrgValue)
cl9.Adding_Domains_Colors_Hint(EntityOrgValue, ListEnDFSHow, Type3_Count, DomainColors, c_white, c_black, dot,driver,domainColTitle,Type3_Domain_selection , Type3_Domain_ID,graphviz_QueryLocation)
