...
import T36_funcCfgs_DFG2_featureValue_Domain_14 as funcConf
import T37_funcs_DFG2_featureValue_Domain_14 as cl9
...
cl9.DF_based_on_Entities(entityList,entityIDlists, EntOrgAbrNum, EntitiesColors, ListEnDFSHow, case_selector1,case_selector2, case_selector_activation, c_white, c_black, dot, driver,DomainColors,domainColTitle,Activity, colTitle,Type2_Domain_selection , Type2_Domain_ID,graphviz_QueryLocation)


print("*********************************DF_based_on_ID************************************************")


cl9.DF_based_on_ID(entityList,refEntityIDlists, ListEnOrgRelDFShow, case_selector1,case_selector2, case_selector_activation, c_white, c_black, SubEntities_Color, dot, driver,Type2_Domain_selection , Type2_Domain_ID,domainColTitle,graphviz_QueryLocation)


print("*********************************Adding_Entities_ID ForFirstEvent**********************************************")

cl9.Adding_Entities_ID_ForFirstEvent(entityList,entityIDlists, EntitiesColors, ListEnDFSHow, case_selector1,case_selector_activation, c_white, c_black, dot, driver,Type2_Domain_selection , Type2_Domain_ID,domainColTitle,graphviz_QueryLocation)


print("*********************************Adding_Entities**********************************************")

cl9.Adding_Entities(entityList, entityIDlists, EntitiesColors, ListEnDFSHow, c_white, c_black, dot, driver,case_selector2, case_selector_activation,Type2_Domain_selection , Type2_Domain_ID,domainColTitle,graphviz_QueryLocation)



print("*********************************Adding_Domains_Colors_Hint***********************************************************")
print("DomainColors=",DomainColors)
cl9.Adding_Domains_Colors_Hint(entityList, entityIDlists, ListEnDFSHow, case_selector1,case_selector_activation, DomainColors, c_white, c_black, dot, driver, domainColTitle,Type2_Domain_selection , Type2_Domain_ID,graphviz_QueryLocation)
