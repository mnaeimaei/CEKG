...
import W22_funcCfgs_DFG5_DomainConceptLevel_Relative_44 as funcConf
import W23_funcs_DFG5_DomainConceptLevel_Relative_44 as cl9
...
if txtFileExistance == True:
    ...
    case_selector1, case_selector_list1 = funcConf.case_Selector1(Type5_Rel_1_DF_Show_selection_ID_instances)
    print("case_selector1=", case_selector1)
    print("case_selector_list1=", case_selector_list1)

    case_selector2, case_selector_list2 = funcConf.case_Selector2(Type5_Rel_2_DF_Show_selection_ID_instances)
...
rel_list_final=[rel_list]
print("rel_list_final=", rel_list_final)
...
print("final_DFG_List_Rel_color=",rel_list_final)
cl9.DFC_Adding_Entities(rel_list_final, Type5_Count, ID_Colors, c_white, c_black,dot, driver,case_selector_activation1,case_selector_list1,case_selector1,case_selector_activation2,case_selector_list2,case_selector2,domainColTitle,Type5_Domain_selection, Type5_Domain_ID,graphviz_QueryLocation)



print("*********************************Adding_Domains_Colors_Hint***********************************************************")
print("final_DFG_List_Rel_color=",rel_list_final)
cl9.Adding_Domains_Colors_Hint(rel_list_final, Type5_Count, DomainColors, c_white, c_black, dot, driver,domainColTitle,case_selector_activation1,case_selector_list1,case_selector1,case_selector_activation2,case_selector_list2,case_selector2,Type5_Domain_selection, Type5_Domain_ID,graphviz_QueryLocation)
