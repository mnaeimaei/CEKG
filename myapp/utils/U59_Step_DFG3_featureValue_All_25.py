...
import U57_funcCfgs_DFG3_featureValue_All_25 as funcConf
import U58_funcs_DFG3_featureValue_All_25 as cl9
...
print("EntityOrgValue=",EntityOrgValue)
cl9.DFC_based_on_Origins(EntityOrgValue, EntOrgAbrNum, EntitiesColors, ListEnDFSHow, Type3_Count, c_white, c_black, dot, driver,Activity, colTitle,graphviz_QueryLocation)



print("*********************************Adding_Entities**********************************************")
print("EntityOrgValue=",EntityOrgValue)
cl9.DFC_Adding_Entities(EntityOrgValue, EntitiesColors, ListEnDFSHow, Type3_Count, driver, c_white, c_black, dot,graphviz_QueryLocation)
