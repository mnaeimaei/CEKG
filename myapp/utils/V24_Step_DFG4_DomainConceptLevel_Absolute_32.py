...
import V22_funcCfgs_DFG4_DomainConceptLevel_Absolute_32 as funcConf
import V23_funcs_DFG4_DomainConceptLevel_Absolute_32 as cl9
...
final_DFG_List_Abs_color = funcConf.final_DFG_List_Absolute_2(EnNum, EntityOrgValue, combining_IDs_List,
                                                              combining_IDs_List_color)
...
print("final_DFG_List_Abs_color=", final_DFG_List_Abs_color)
cl9.DFC_based_on_Origins(final_DFG_List_Abs_color, ID_Colors, ListEnDFSHow, Type4_Count, case_selector,
                         case_selector_activation, c_white, c_black, dot, driver, DomainColors, domainColTitle,
                         Activity, colTitle, Type4_Domain_selection, Type4_Domain_ID,graphviz_QueryLocation)

print("*********************************Adding_Entities**********************************************")
print("final_DFG_List_Abs_color=", final_DFG_List_Abs_color)
cl9.DFC_Adding_Entities(final_DFG_List_Abs_color, ID_Colors, ListEnDFSHow, Type4_Count, case_selector,
                        case_selector_activation, case_selector_list, c_white, c_black, dot, driver,
                        Type4_Domain_selection, Type4_Domain_ID, domainColTitle,graphviz_QueryLocation)

print("*********************************Adding_Domains_Colors_Hint**********************************************")
print("final_DFG_List_Abs_color=", final_DFG_List_Abs_color)
cl9.Adding_Domains_Colors_Hint(final_DFG_List_Abs_color, ListEnDFSHow, Type4_Count, case_selector,
                               case_selector_activation, DomainColors, c_white, c_black, dot, driver, domainColTitle,
