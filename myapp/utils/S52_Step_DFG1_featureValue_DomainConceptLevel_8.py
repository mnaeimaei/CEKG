...
import S50_funcCfgs_DFG1_featureValue_DomainConceptLevel_8 as funcConf
import S51_funcs_DFG1_featureValue_DomainConceptLevel_8 as cl9
...
if txtFileExistance == True:
    ...
    Type1_approach = txtF.TypeApproach(generalFileName, "Type1_approach")
    ...
    Type1_feature_Name = txtF.listIntTxt(generalFileName, "Type1_feature_Name")
    print("Type1_feature_Name=", Type1_feature_Name)

    Type1_feature_label = txtF.listIntTxt(generalFileName, "Type1_feature_label")
    print("Type1_feature_label=", Type1_feature_label)

    Type1_feature_Value = txtF.listIntTxt(generalFileName, "Type1_feature_Value")
    print("Type1_feature_Value=", Type1_feature_Value)

    Type1_Domain_selection = txtF.TrueFalseTxt(generalFileName, "Type1_Domain_selection")
    print("Type1_Domain_selection=", Type1_Domain_selection)

    Type1_Domain_ID = txtF.listIntTxt(generalFileName, "Type1_Domain_ID")
    print("Type1_Domain_ID=", Type1_Domain_ID)
    ...
    if Type1_approach == 2:
        # Type1_selection_ID_new,Type1_selection_ID_instances_new  = funcConf.case_Selector_pre1(Type1_selection_ID,Type1_feature_Name, Type1_feature_label,Type1_feature_Value,driver )
        # print("Type1_selection_ID_new=", Type1_selection_ID_new)
        # print("Type1_selection_ID_instances_new=", Type1_selection_ID_instances_new)

        # result
        # Type1_selection_ID_new==['Patient', 'Admission', 'Concept']
        # Type1_selection_ID_instances_new=[['1'], ['1'], ['1']]

        Type1_selection_ID_instances_new = funcConf.case_Selector_pre2(Type1_selection_ID, Type1_feature_Name,
                                                                       Type1_feature_label, Type1_feature_Value, driver)
        print("Type1_selection_ID_instances_new=", Type1_selection_ID_instances_new)

        case_selector = funcConf.case_Selector(Type1_selection_ID, Type1_selection_ID_instances_new)
        print("case_selector=", case_selector)
...
cl9.DF_based_on_Entities(entityList, entityIDlists, EntOrgAbrNum, DomainColors, EntitiesColors, ListEnDFSHow, c_white,
                         c_black, dot, driver, domainColTitle, case_selector,
                         case_selector_activation, Type1_Domain_selection, Type1_Domain_ID, Activity, colTitle,graphviz_QueryLocation)

print("*********************************Adding_Entities_ID ForFirstEvent**********************************************")
cl9.Adding_Entities_ID_ForFirstEvent(entityList, entityIDlists, EntitiesColors, ListEnDFSHow, c_white, c_black, dot,
...
print("DomainColors=", DomainColors)
cl9.Adding_Domains_Colors_Hint(entityList, entityIDlists, ListEnDFSHow, case_selector, case_selector_activation,
                               DomainColors, c_white, c_black, dot, driver, domainColTitle, Type1_Domain_selection,
                               Type1_Domain_ID,graphviz_QueryLocation)
