...
def DFC_based_on_Origins (EntityOrgValue, DomainColors, EntitiesColors, ListEnDFSHow, count, c_white, c_black, dot, driver,domainColTitle,activityScenario, colTitle,Type1_Domain_selection , Type1_Domain_ID, graphviz_QueryLocation):
        ...
        if Show == 1:
            for model_entities in EntityOrgValue_list:
                ...
                query1 = f'''     
                            ...
                            WHERE df.count >= {number} and df.Type = "All" and df.En1="{En1}" and df.En1_ID="0" {domExpression1} 
...
def DFC_Adding_Entities (EntityOrgValue, EntitiesColors, ListEnDFSHow, count, driver, c_white, c_black, dot,domainColTitle,Type1_Domain_selection , Type1_Domain_ID, graphviz_QueryLocation):
    list3 = []
...
def Adding_Domains_Colors_Hint (EntityOrgValue, ListEnDFSHow, count, DomainColors, c_white, c_black, dot, driver,domainColTitle,Type1_Domain_selection , Type1_Domain_ID, graphviz_QueryLocation):
    list3 = []
    ...
    for EntityOrgValue_list, Show in zip(EntityOrgValue, ListEnDFSHow):
        if Show == 1:
            ...
            for model_entities in EntityOrgValue_list:
                ...
                if Type1_Domain_selection == True:
                    domExpression1 = " and d1." + domainColTitle + " in " + str(Type1_Domain_ID) + " and d2." + domainColTitle + " in " + str(Type1_Domain_ID)
                    domExpression2 = " WHERE d1." + domainColTitle + " in " + str(Type1_Domain_ID)
                    domExpression3 = " and d." + domainColTitle + " in " + str(Type1_Domain_ID)
                ...
                if record1:
                    d1_domain = [item[3][domainColTitle] for item in record1]
                    list2.extend(d1_domain)
                    d2_domain = [item[4][domainColTitle] for item in record1]
                    list2.extend(d2_domain)
