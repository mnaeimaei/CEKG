...
###################Graph Functions"""""""""""""""""""""""""""""""""""
def DF_based_on_Entities(entityList, entityIDlists, EntOrgAbrNum, DomainColors, EntitiesColors, ListEnDFSHow, c_white,
                         c_black, dot, driver, domainColTitle, case_selector,
                         case_selector_activation,Type1_Domain_selection , Type1_Domain_ID,activityScenario, colTitle, graphviz_QueryLocation):
        ...
        if Show == 1:
            for eachID in EntityIDList:
                ...
                query1 = f'''     
                        ...
                        WHERE n1.ID="{eachID}" and df.ID="{eachID}" and r.ID="{eachID}" {actExpression1} {domExpression1} 
                ...
                if record1:
                    ...
                    print("e1_domain=", e1_domain)
                    print("e2_domain=", e2_domain)

                    if show_lifecycle:
                        e1_lifecycle = [item[2]["lifecycle"] for item in record1]
                    ...
                    for i in range(len(record1)):
                        ...
                        dot.node(str(f1_Neo4J_ID_new_2nd[i]), f_node[i], color=Node_Around_Color, penwidth="2", style="filled",
...
def Adding_Entities_ID_ForFirstEvent(entityList, entityIDlists, EntitiesColors, ListEnDFSHow, c_white, c_black, dot,
                                     driver, case_selector,
                                     case_selector_activation,Type1_Domain_selection , Type1_Domain_ID,domainColTitle, graphviz_QueryLocation):
    for eachEntity, EntityIDList, Color, Show in zip(entityList, entityIDlists, EntitiesColors, ListEnDFSHow):
        if Show == 1:
            for eachID in EntityIDList:
...
def Adding_Entities(entityList, entityIDlists, EntitiesColors, ListEnDFSHow, c_white, c_black, dot, driver,
                    case_selector, case_selector_activation,Type1_Domain_selection , Type1_Domain_ID,domainColTitle, graphviz_QueryLocation):
    list3 = []
...
def Adding_Domains_Colors_Hint(entityList, entityIDlists, ListEnDFSHow, case_selector, case_selector_activation,
