...
import T29_funcCfgs_DFG2_featureValue_13 as funcConf
import T30_funcs_DFG2_featureValue_13 as cl9
...
if txtFileExistance == True:
    ...
    if Type2_approach == 2:
        ...
        Type2_selection_ID_instances_new  = funcConf.case_Selector_pre2(Type2_selection_ID,Type2_feature_Name, Type2_feature_label,Type2_feature_Value,driver )
        print("Type2_selection_ID_instances_new=", Type2_selection_ID_instances_new)
...
cl9.DF_based_on_Entities(entityList,entityIDlists, EntOrgAbrNum, EntitiesColors, ListEnDFSHow, case_selector1,case_selector2, case_selector_activation, c_white, c_black, dot, driver,Activity, colTitle,graphviz_QueryLocation)


print("*********************************DF_based_on_ID************************************************")


cl9.DF_based_on_ID(entityList,refEntityIDlists, ListEnOrgRelDFShow, case_selector1,case_selector2, case_selector_activation, c_white, c_black, SubEntities_Color, dot, driver,graphviz_QueryLocation)


print("*********************************Adding_Entities_ID ForFirstEvent**********************************************")

cl9.Adding_Entities_ID_ForFirstEvent(entityList,entityIDlists, EntitiesColors, ListEnDFSHow, case_selector1,case_selector_activation, c_white, c_black, dot, driver,graphviz_QueryLocation)


print("*********************************Adding_Entities**********************************************")

cl9.Adding_Entities(entityList, entityIDlists, EntitiesColors, ListEnDFSHow, c_white, c_black, dot, driver,case_selector2, case_selector_activation,graphviz_QueryLocation)
