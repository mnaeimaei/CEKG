        ...
        if Show == 1:
            for eachID in EntityIDList:
                ...
                query1 = f'''     
                    ...
                    WHERE n1.ID="{eachID}" AND n2.ID="{eachID}" and df.ID="{eachID}" {actExpression2}  {domExpression1} 
                    return distinct a1,e1, df, e2,a2,d1,d2 {asExpression3}
                ...
                if record1:
                    ...
                    e1_domain = [item[5][domainColTitle] for item in record1]
                    e2_domain = [item[6][domainColTitle] for item in record1]

                    if activityScenario=="Activity_Label":
                        e1_Activity = [item[0][colTitle] for item in record1]
                        e2_Activity = [item[4][colTitle] for item in record1]
                    else:
                        e1_Activity = [item[7][colTitle] for item in record1]
                        e2_Activity = [item[8][colTitle] for item in record1]
                ...
                if not record1:
                    ...
                    query2 = f'''     
                            ...
                            return distinct e1,a1,d1{asExpression4}  
                                         '''
                    ...
                    with driver.session() as session:
                        ...
                        e1_domain = [item[2][domainColTitle] for item in record2]
