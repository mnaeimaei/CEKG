...
import S36_funcCfgs_DFG1_featureValue_Domain_6 as funcConf
import S37_funcs_DFG1_featureValue_Domain_6 as cl9
...
if txtFileExistance == True:
    ...
    if Type1_approach == 2:
        ...
        Type1_selection_ID_instances_new  = funcConf.case_Selector_pre2(Type1_selection_ID,Type1_feature_Name, Type1_feature_label,Type1_feature_Value,driver )
        print("Type1_selection_ID_instances_new=", Type1_selection_ID_instances_new)
...
cl9.DF_based_on_Entities(entityList,entityIDlists, EntOrgAbrNum, DomainColors, EntitiesColors, ListEnDFSHow, c_white, c_black, dot, driver, domainColTitle,case_selector,
...
print("DomainColors=",DomainColors)
cl9.Adding_Domains_Colors_Hint(entityList,entityIDlists, ListEnDFSHow, case_selector, case_selector_activation, DomainColors, c_white, c_black, dot, driver, domainColTitle,Type1_Domain_selection , Type1_Domain_ID,graphviz_QueryLocation)
